...
export default function AssetImport() {
  ...
  const csvboxKey = process.env.NEXT_PUBLIC_CSV_BOX_ASSET_IMPORT_LICENSE_KEY as string;
  const user_id = process.env.NEXT_PUBLIC_CSV_BOX_USER_ID as string;
      ...
      <div className="mt-6 flex max-w-md gap-x-4">
          <CSVBoxButton
            ...
            render={(launch: any, isLoading: boolean) => {
              ...
              onClick={launch}> {isLoading ? 'loading...' : 'Upload  Product Image CSV'}</button>;
            }}
          >
            Import
          </CSVBoxButton>
